...
export const DEPLOYMENT_STATE_META: Record<DeploymentState, StateMeta> = {
  ...
  PREPARED: { label: "Prepared", dotClass: "bg-slot-reserved", textClass: "text-slot-reserved" },
  ...
  WAITING_HEALTH: { label: "Health check", dotClass: "bg-slot-reserved", textClass: "text-slot-reserved" },
  PUBLISHING: { label: "Publishing", dotClass: "bg-slot-reserved", textClass: "text-slot-reserved" },
  PUBLISH_FAILED: { label: "Publish failed", dotClass: "bg-slot-failed", textClass: "text-slot-failed" },
